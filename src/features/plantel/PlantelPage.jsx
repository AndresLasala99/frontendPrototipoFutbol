...
export default function PlantelPage() {
  ...
  const esAdmin = usuario && ["admin", "dt"].includes(usuario.rol);
  ...
  return (
    <div className="panel">
      ...
      <div className="player-cards">
        {lista.map((j) => (
          <PlayerCard key={j._id} jugador={j} onAbrir={setJugadorAbierto} onToggleLesion={toggleLesion} onToggleCarga={toggleCarga} />
        ))}
      </div>
