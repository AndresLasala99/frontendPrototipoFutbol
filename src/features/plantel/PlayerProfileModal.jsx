...
export default function PlayerProfileModal({ jugador, campeonatos, puedeEliminar, onEliminar, onClose, onActualizado }) {
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="profile-grid">
          ...
          <div>
            ...
            <input defaultValue={form.posicion} onBlur={(e) => guardarCampo("posicion", e.target.value)} />
          </div>
          <div>
        ...
        <div className="injury-row">
          ...
          />
          <button className="small-btn" onClick={agregarLesion}>
            + Agregar
          </button>
        </div>
