...
export default function MicrocicloGrid({ microciclo, onEditarEtiqueta, onAbrirCelda, onCambiarNivel, onAgregarFila, onEliminarFila, onRestablecer, puedeEliminar }) {
          ...
          {dias.map((d) => (
            <div key={d.fecha} style={{ textAlign: "center", fontSize: 13, fontWeight: 600 }}>
              <span
                ...
                onBlur={(e) => onEditarEtiqueta(d.fecha, e.target.textContent)}
