...
export default function MatchPanel({ fecha, jugadores, campeonatos, puedeEliminar, puedeGuardar = true, onClose, onEliminado, onCambio }) {
            ...
            return (
              ...
              >
                <input
                  ...
                  disabled={lesionado || !puedeGuardar}
